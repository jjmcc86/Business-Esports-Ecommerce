...
<div class="landing parallax" style="background-image:url('/images/Esports Image 2.jpg');" data-img-width="2000" data-img-height="1325" data-diff="100">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					...
					<div class="landing-text wow fadeInUp">
						<p>Corporate Esports events with a charitable impact</p>
					</div>				  
	...
	<nav class="navbar-wrapper navbar-default" role="navigation">
		<div class="container">
			  <div class="navbar-header">
				...
				<a class="navbar-brand site-name" href="#top"><img src="/images/Business Esports Cropped Logo.PNG" alt="logo"></a>
			  </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
						...
						<div class="btn-section"><a href="#download" class="btn-default">Apply Now</a></div>
					</div>					
				</div>
			</div>
		</div>
...
<footer id="footer">
	<div class="container">
		<div class="col-sm-4 col-sm-offset-4">
			...
			<div class="text-center wow fadeInUp" style="font-size: 14px;">Copyright Businessr 2015</div>
